  ...
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        ...
        <Toaster />
        {/* Start Now — fixed at hero seam: navbar(56px) + hero-min(260px) = 316px mobile, 60vh on md+ */}
        <div className="fixed right-4 sm:right-6 top-[316px] md:top-[60vh] -translate-y-1/2 z-50">
