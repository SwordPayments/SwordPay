        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="shrink-0 mt-12 sm:mt-16 flex items-start gap-1" style={{position: 'relative'}}>
              <span className="animate-arrow-seq-flash text-white text-[4.8vw] md:text-[2.58rem]" style={{display: 'inline-block', alignSelf: 'flex-start', marginTop: '90px', animationDelay: '3s', animationFillMode: 'backwards', textShadow: '0 0 12px rgba(99,179,255,1), 0 0 24px rgba(99,179,255,0.8)', verticalAlign: 'top'}}>→</span>
              <span className="animate-arrow-seq-flash text-white text-[4.8vw] md:text-[2.58rem]" style={{display: 'inline-block', alignSelf: 'flex-start', marginTop: '290px', position: 'absolute', textShadow: '0 0 12px rgba(99,179,255,1), 0 0 24px rgba(99,179,255,0.8)', verticalAlign: 'top', animationDelay: '1.2s', animationFillMode: 'backwards'}}>→</span>
              <span className="animate-arrow-seq-flash text-white text-[4.8vw] md:text-[2.58rem]" style={{display: 'inline-block', alignSelf: 'flex-start', marginTop: '217px', position: 'absolute', textShadow: '0 0 12px rgba(99,179,255,1), 0 0 24px rgba(99,179,255,0.8)', verticalAlign: 'top', animationDelay: '0s', animationFillMode: 'backwards'}}>→</span>
