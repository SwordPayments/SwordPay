      ...
      <section className="relative overflow-hidden min-h-[500px] md:min-h-[600px]" data-testid="hero-section">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36">
          <div className="max-w-5xl">
            <div className="mb-6">
              <h1 className="text-[8.5vw] md:text-[4.73rem] font-bold text-white leading-tight tracking-tight mb-4 whitespace-nowrap [text-shadow:0_0_30px_rgba(255,255,255,0.35)]">
                Sell Any File in Seconds
              </h1>
              <p
                className={`flex flex-nowrap items-baseline text-[8.8vw] md:text-[4.3rem] font-bold text-white leading-tight tracking-tight [text-shadow:0_0_30px_rgba(255,255,255,0.35)] transition-opacity duration-500 ${
